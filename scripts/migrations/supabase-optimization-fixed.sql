-- COMPLETE DATABASE OPTIMIZATION FOR SUPABASE (FIXED)
...
-- ============================================================
-- PHASE 2: RECREATE LATEST_SENSOR_DATA VIEW
-- ============================================================

-- Drop the old view that depends on people_counting_data
DROP VIEW IF EXISTS latest_sensor_data;

-- Recreate it to use people_counting_raw instead
