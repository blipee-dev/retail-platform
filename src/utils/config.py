...
stores = {
    ...
    "OML02-Omnia Fórum Almada": ["http://188.37.175.41:2201/"],
    "OML03-Omnia Norteshopping": ["http://188.37.124.33:21002/"],
    "ONL02-Only Gaia": ["http://62.48.154.135:21001/", "http://62.48.154.135:21002/"]
}
...
# Token do Telegram
TELEGRAM_TOKEN = os.getenv('TELEGRAM_TOKEN', "7320381187:AAGGqR6KIQySaEP7P_ucCf_9HV-gku7duM8")     # Token do bot.py
TELEGRAM_TOKEN_TEST = os.getenv('TELEGRAM_TOKEN_TEST', "6673747177:AAGqX0BT0WFCBUjBpwrXt0tv4PjwdcpawSQ")   # Token do bot de teste
TELEGRAM_TOKEN_NOTIFY = os.getenv('TELEGRAM_TOKEN_NOTIFY', "7367819646:AAF6RRFdePvltDzI9QuNjHgo2EQAE2Ob_0o")  # Token do bot de de Notificações
...
EMAIL_CONFIG = {
    ...
    'SMTP_USER': os.getenv('EMAIL_USER', 'pedro@blipee.com'),
    'SMTP_PASSWORD': os.getenv('EMAIL_PASSWORD', 'dptc xmxt vlwl hvgk'),
    'FROM_EMAIL': os.getenv('EMAIL_FROM', 'no-reply@blipee.com'),
    'TO_EMAILS': os.getenv('EMAIL_TO', 'pedro@blipee.com, martaamendoeira@mainfashion.pt, gilgoncalves@maintarget.pt').split(',')
}
